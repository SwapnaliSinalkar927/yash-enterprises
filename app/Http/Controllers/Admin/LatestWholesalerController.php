...
use Gate;
use DataTables;
use App\Models\{Wholesaler,State,City,Pincode,Code,WholesalerLoginHistory,WholesalerPaymentDetail,Payout,Order,WD,LatestWholesaler};
...
class LatestWholesalerController extends Controller
{
   public function index()
    {
        if(Gate::denies('latest_wholesaler_access')) {
            return redirect()->route('admin.home')->with([
                'status' => 'failed',
                'message' => 'This action is unauthorized',
            ]);
        }
        return view('admin.latest-wholesalers.index');
    }

    public function latestWholesalerList(Request $request){
        // $wholesalers = Wholesaler::all();
        $wholesalers = LatestWholesaler::all();
