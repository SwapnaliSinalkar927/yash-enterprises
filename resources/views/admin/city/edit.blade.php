    ...
    <div class="container-fluid p-5 pb-0">
        ...
        <div class="hk-pg-body mt-2">
            <div class="tab-pane fade show active" id="tab_block_1">
                <form action="{{ route('admin.cities.update',$city->id) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                    <div class="row">
                        <div class="col-sm-8">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('name') ?? $city->name }}" id="name" name="name" required>
                                                @error('name')
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select name="state_id" id="state_id" class="form-select @error('state_id') is-invalid @enderror js-example-basic-single" value="{{ old('state_id') }}">
                                                    ...
                                                    <option value="{{ $state->id }}" @if($state->id == $city->state_id || $state->id == old('state_id')) selected @endif>{{ $state->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('state_id')
                                                <div class="invalid-feedback">
