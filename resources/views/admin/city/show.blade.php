...
<div class="hk-pg-wrapper">
    <div class="container-fluid p-5 pb-0">
        ...
        City's Detail
            {!! ($city->status==1) ? '<span class="badge badge-sm badge-success">Active</span>' : '<span class="badge badge-sm badge-danger">Inactive</span>' !!}
            @can('city_edit')
            <a href="{{ route('admin.cities.edit', $city->id) }}" class="text-primary btn btn-rounded flush-soft-hover edit-button p-0" data-toggle="tooltip"
                            ...
                            <table class="table mb-0 mt-2" style="overflow-x:auto;display:table;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.states.show',$city->state_id) }}">{{ $city->state->name }}</a></td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="card-line bg-primary table-card-line"></div>
                                <a href="{{ route('admin.wholesalers.index',['city_id' => $city->id ]) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card-line bg-primary table-card-line"></div>
                                <a href="{{ route('admin.generate-codes.index',['city_id' => $city->id ]) }}">
                                    <div class="card card-shadow mb-0">
                                        <div class="card-header card-header-action">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card-line bg-primary table-card-line"></div>
                                <a href="{{ route('admin.orders.index',['city_id' => $city->id ]) }}">
                                    <div class="card card-shadow mb-0">
                                        <div class="card-header card-header-action">
                                            <h6>Order Count</h6>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-wth-line p-3">
                            <h5 class="mb-3">Wholesalers in {{ $city->name }}</h5>
                            <!-- <div class="card-line bg-primary table-card-line"></div> -->
                            <!-- <div class="card-body"></div> -->
                    ...
                    <div class="col-md-6">
                        <div class="card card-wth-line p-3">
                            <h5 class="mb-3">Orders in {{ $city->name }}</h5>
                            <!-- <div class="card-line bg-primary table-card-line"></div> -->
                            <!-- <div class="card-body"></div> -->
...
@section('script')
    <script>
        $( document ).ready(function() {
            created_at_data = "{{  $city->created_at }}";
            ...
            var table = $("#example").DataTable({
                ...
                ajax: "{{ route('admin.city.wholesalers.list',['city_id'=> $city->id]) }}",
                columns: [
                    { 
                        data: 'full_name',
                        name: 'full_name',
            ...
            var table = $("#order").DataTable({
                ...
                ajax: "{{ route('admin.city.orders.list',['city_id'=> $city->id]) }}",
                columns: [
                    { 
