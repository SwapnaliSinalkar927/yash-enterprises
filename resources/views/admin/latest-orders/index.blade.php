    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $("#example").DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.latest-orders.list') }}", // base route without query params
                    data: function(d) {
                ...
                columns: [
                    { 
                        data: 'latest_wholesaler.full_name', 
                        name: 'latest_wholesaler.full_name',
                        render: function(data, type, row) {
                            var name = row.latest_wholesaler.full_name;
                            return name;
                        }
                    },
                    { 
                        data: 'latest_code.code', 
                        name: 'latest_code.code',
                        render: function(data, type, row) {
                            var code = row.latest_code.code;
                            return code;
                        }
                    },
                    { 
