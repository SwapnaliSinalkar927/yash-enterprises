...
<div class="hk-pg-wrapper">
    <div class="container-fluid p-5 pb-0">
        ...
        Pincode's Detail
            {!! ($pincode->status==1) ? '<span class="badge badge-sm badge-success">Active</span>' : '<span class="badge badge-sm badge-danger">Inactive</span>' !!}
            @can('pincode_edit')
            <a href="{{ route('admin.pincodes.edit', $pincode->id) }}" class="text-primary btn btn-rounded flush-soft-hover edit-button p-0" data-toggle="tooltip"
                            ...
                            <table class="table mb-0 mt-2" style="overflow-x:auto;display:table;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.cities.show',$pincode->city_id) }}">{{ $pincode->city->name }}</a></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">State :</th>
                                        <td><a href="{{ route('admin.states.show',$pincode->city->state_id) }}">{{ $pincode->city->state->name }}</a></td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="card-line bg-primary table-card-line"></div>
                                <a href="{{ route('admin.wholesalers.index',['pincode_id' => $pincode->id ]) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card-line bg-primary table-card-line"></div>
                                <a href="{{ route('admin.generate-codes.index',['pincode_id' => $pincode->id ]) }}">
                                    <div class="card card-shadow mb-0">
                                        <div class="card-header card-header-action">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card-line bg-primary table-card-line"></div>
                                <a href="{{ route('admin.orders.index',['pincode_id' => $pincode->id ]) }}">
                                    <div class="card card-shadow mb-0">
                                        <div class="card-header card-header-action">
                                            <h6>Order Count</h6>
                                        </div>
...
@section('script')
    <script>
        $( document ).ready(function() {
            created_at_data = "{{  $pincode->created_at }}";
            ...
            var table = $("#example").DataTable({
                ...
                ajax: "{{ route('admin.pincode.wholesalers.list',['pincode_id'=> $pincode->id]) }}",
                columns: [
                    { 
                        data: 'full_name',
                        name: 'full_name',
            ...
            var table = $("#order").DataTable({
                ...
                ajax: "{{ route('admin.pincode.orders.list',['pincode_id'=> $pincode->id]) }}",
                columns: [
                    { 
