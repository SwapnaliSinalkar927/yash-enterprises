    ...
    <div class="container-fluid p-5 pb-0">
        ...
        <div class="hk-pg-body mt-2">
            <div class="tab-pane fade show active" id="tab_block_1">
                <form action="{{ route('admin.states.update', [$state->id]) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                    <div class="row">
                        <div class="col-sm-8">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('name') ?? $state->name }}" id="name" name="name" required>
                                                @error('name')
                                    ...
                                    <div class="card card-wth-line">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <select name="status" id="activeStatus" class="form-select">
                                                <option value="1" {{ $state->status == "1" || old('status')== "1"  ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ $state->status == "0" || old('status')== "0"  ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                        </div>
