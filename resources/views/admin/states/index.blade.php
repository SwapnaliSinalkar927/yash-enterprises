                ...
                <div class="hk-example card card-shadow card-wth-tabs  mt-3" >
                    <div class="card-header">
                        ...
                        <div class="page-title-right">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary add">Add State</button>
                                    <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="mdi mdi-chevron-down"></i>
                                    </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('admin.states.create') }}">Add
                                                State</a>
    ...
    <div class="modal fade" id="uploadCSV" tabindex="-1" role="dialog" aria-labelledby="uploadCSVTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.bulk_states_upload') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <p>Download a <a href="{{ asset('sample_csv/states.csv') }}" download>sample CSV template</a> to see an example of the format required.</p>
                                <div class="mt-3">
                ...
                columns: [
                    { 
                        ...
                        render: function(data, type, row) {
                            var name = row.name;
                            @can('state_show')
                                var showUrl = '{{ route('admin.states.show',':stateID') }}'.replace(':stateID', row.id);
                    ...
                    { 
                        ...
                        render: function(data, type, row) {
                            ...
                            var show = '';
                            @can('state_edit')
                                var editURL = '{{ route('admin.states.edit',':stateID') }}'.replace(':stateID', row.id);
