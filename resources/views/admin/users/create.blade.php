                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group auth-pass-inputgroup">
                                                        <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" id="password" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon"  autocomplete="off">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control @error('roles') is-invalid @enderror multiple-select" name="roles[]"  data-placeholder="-- Please select --" multiple="multiple" id="roles">
                                                        ...
                                                        <option value="{{ $role->id }}" {{ in_array($role->id, old('roles', [])) ? 'selected' : '' }}>{{ $role->slug }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('roles')
                                                        <div class="invalid-feedback">
