    ...
    <div class="container-fluid p-5 pb-0">
        ...
        <div class="hk-pg-body mt-2">
            <div class="tab-pane fade show active" id="tab_block_1">
                <form action="{{ route('admin.wds.store') }}" method="POST" class="needs-validation" novalidate>
                @csrf
                    <div class="row">
                        <div class="col-sm-8">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('firm_name') }}" id="firm_name" name="firm_name" required>
                                                @error('firm_name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('tb') }}" id="tb" name="tb" required>
                                                @error('tb')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('location') }}" id="location" name="location" required>
                                                @error('location')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
