    ...
    <div class="container-fluid p-5 pb-0">
        ...
        <div class="hk-pg-body mt-2">
            <div class="tab-pane fade show active" id="tab_block_1">
                <form action="{{ route('admin.wholesalers.update',$wholesaler->id) }}" method="POST">
                @csrf
                @method('PUT')
                    <div class="row">
                        <div class="col-sm-8">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('full_name') ?? $wholesaler->full_name }}" id="full_name" name="full_name" required>
                                                        @error('full_name')
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('mobile_number') ?? $wholesaler->mobile_number }}" id="mobile_number" name="mobile_number" required>
                                                        @error('mobile_number')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('pincode') ?? $wholesaler->pincode }}" id="pincode" name="pincode">
                                                        @error('pincode')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
