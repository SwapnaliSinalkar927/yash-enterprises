...
<!--Start Page Header-->
        ...
        <section class="pricing-plan-one">
            <div class="pricing-plan-one__pattern"
                style="background-image: url({{ asset('images/pattern/pricing-v1-pattern.png') }});"></div>
            <div class="container">
        ...
        <section class="testimonial-three">
            <div class="testimonial-three__pattern"><img src="{{ asset('images/pattern/testimonial-v3-pattern.png') }}" alt="">
            </div>
            <div class="container">
                <div class="row">
                                ...
                                <ul class="testimonial-three__reviews-list">
                                    <li>
                                        <div class="testimonial-three__reviews-img">
                                            <img src="{{ asset('images/resources/satisfied-partner-img1.jpg') }}" alt="">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="testimonial-three__reviews-img">
                                            <img src="{{ asset('images/resources/satisfied-partner-img2.jpg') }}" alt="">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="testimonial-three__reviews-img">
                                            <img src="{{ asset('images/resources/satisfied-partner-img3.jpg') }}" alt="">
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="testimonial-three__carousel owl-carousel owl-theme">
                                ...
                                <div class="testimonial-three__single">
                                    <div class="testimonial-three__single-inner">
                                        ...
                                        <div class="testimonial-three__single-bottom">
                                            <div class="img-box">
                                                <img src="{{ asset('images/testimonial/testimonial-v3-img1.jpg') }}" alt="">
                                            </div>
                                ...
                                <div class="testimonial-three__single">
                                    <div class="testimonial-three__single-inner">
                                        ...
                                        <div class="testimonial-three__single-bottom">
                                            <div class="img-box">
                                                <img src="{{ asset('images/testimonial/testimonial-v3-img2.jpg') }}" alt="">
                                            </div>
                                            <div class="author-info">
